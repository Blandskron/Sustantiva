...
# Definición de la función para cargar las tareas desde un archivo
def load_tasks():
    try:
...
# Definición de la función para guardar las tareas en un archivo
...
def main():
    tasks = load_tasks()  # Cargar las tareas desde el archivo
    ...
    while True:
        ...
        if choice == '1':
            ...
            tasks.append(task)
            save_tasks(tasks)  # Guardar las tareas actualizadas en el archivo
